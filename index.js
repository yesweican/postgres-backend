...
import videocommentsRoutes from "./routes/video-comment-route.js";
import videoLikesRoutes from "./routes/videolike-route.js";
import followingRoutes from "./routes/following-route.js";
import followerRoutes from "./routes/follower-route.js";
import channelRoutes from "./routes/channel-route.js";
import channelSubscribersRoutes from "./routes/channel-subscriber-route.js";
import channelVideosRoutes from "./routes/channel-video-route.js";
...
app.use("/api/videocomments", videocommentsRoutes);
app.use("/api/videolikes", videoLikesRoutes);
app.use("/api/comments", commentsRoutes);
app.use("/api/following", followingRoutes);
app.use("/api/follower", followerRoutes);
app.use("/api/channel", channelRoutes);
app.use("/api/channelsubscribers", channelSubscribersRoutes);
app.use("/api/channelvideos", channelVideosRoutes);
